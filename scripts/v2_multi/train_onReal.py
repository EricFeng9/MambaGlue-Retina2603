    ...
    def setup(self, stage=None):
        if stage == 'fit' or stage is None:
            ...
            if self.args.mode == 'cfoct':
                ...
                self.val_dataset = RealDatasetWrapper(val_base, split_name='test', dataset_name='CFOCT')
                ...
                self.val_dataset = RealDatasetWrapper(val_base, split_name='test', dataset_name='OCTFA')
                ...
                self.val_dataset = RealDatasetWrapper(val_base, split_name='test', dataset_name='CFFA')
...
class PL_MambaGlue_Real(pl.LightningModule):
    def __init__(self, config, result_dir=None):
        ...
        # 用于累积验证误差（在 validation_step 中使用）
