"""
针对 train_onMultiGen_vessels_enhanced 训练权重的测试脚本 (MambaGlue版本)
...
def load_trained_model(ckpt_path, config, output_dir):
    ...
    import importlib
    module = importlib.import_module('scripts.v3.train_onMultiGen_vessels_enhanced')
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="针对 train_onMultiGen_vessels_enhanced 权重的测试脚本（三个全量数据集）- MambaGlue版本"
    )
