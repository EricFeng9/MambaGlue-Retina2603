...
class PL_MambaGlue_Gen(pl.LightningModule):
    ...
    def forward(self, batch):
        ...
        # 3. 激活上下文推理：Feature Dropout -> 单点特征不可靠 -> Mamba 必须利用序列上下文（血管拓扑）
        # ==========================================
        if self.training:
            ...
            # 策略 2: 特征 Dropout（强迫 Mamba 利用上下文序列）
...
# ==========================================
def parse_args():
    parser = argparse.ArgumentParser(description="MambaGlue Feature-Level Domain Randomization + Vessel-Guided Training")
